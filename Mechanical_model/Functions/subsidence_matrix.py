...
def create_subsidence_matrix_fromGF(MESH, B, GF_vertical_displacement,folder) :
    ...
    G_new_mesh = np.matmul(GF_vertical_displacement.T, correspondance_matrix) * 1e6 #because the pressure is now in MPa

    np.save (folder+'GF_vert_disp_new_mesh.npy', G_new_mesh)
